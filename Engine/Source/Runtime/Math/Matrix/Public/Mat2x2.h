...
struct Mat<T, 2, 2>
{
    ...
    static const u64 numRows = 2;
    static const u64 numCols = 2;
    static const u64 rowSize = 2;
    static const u64 colSize = 2;
    ...
    template<typename U>
    Mat<T, 2, 2>& operator=(const Mat<U, 2, 2>& other);

    template<typename U>
    Mat<T, 2, 2>& operator+=(const Mat<U, 2, 2>& other);

    template<typename U>
    Mat<T, 2, 2>& operator+=(U val);
