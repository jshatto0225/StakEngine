...
template<typename T>
T& Mat<T, 2, 2>::operator()(u64 r, u64 c)
{
    if(r > 1 || r < 0 || c > 1 || c < 0)
    {
...
{
    return Mat<T, 2, 2> { m1.a11 + static_cast<T>(m2.a11), m1.a12 + static_cast<T>(m2.a12),
...
Mat<T, 2, 2> operator*(const Mat<T, 2, 2>& m1, const Mat<U, 2, 2>& m2)
{
    return Mat<T, 2, 2> { m1.a11 * static_cast<T>(m2.a11) + m1.a12 * static_cast<T>(m2.a21), m1.a11 * static_cast<T>(m2.a12) + m1.a12 * static_cast<T>(m2.a22),
                          m1.a21 * static_cast<T>(m2.a11) + m1.a22 * static_cast<T>(m2.a21), m1.a21 * static_cast<T>(m2.a12) + m1.a22 * static_cast<T>(m2.a22) };
}
...
{
    return (m1.a11 == static_cast<T>(m2.a11) && m1.a12 == static_cast<T>(m2.a12)
         && m1.a21 == static_cast<T>(m2.a21) && m1.a22 == static_cast<T>(m2.a22));
}
