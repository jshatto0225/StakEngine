...
struct Mat<T, 3, 3>
{
    ...
    static const u64 numRows = 3;
    static const u64 numCols = 3;
    static const u64 rowSize = 3;
    static const u64 colSize = 3;
    ...
    Mat(A11 a11, A12 a12, A13 a13,
        A21 a21, A22 a22, A23 a23,
        A31 a31, A32 a32, A33 a33);

    template<typename U>
    Mat(const Mat<U, 3, 3>& other);

    T& operator()(u64 r, u64 c);
    T operator()(u64 r, u64 c) const;

    template<typename U>
    Mat<T, 3, 3>& operator=(const Mat<U, 3, 3>& other);

    template<typename U>
    Mat<T, 3, 3>& operator+=(const Mat<U, 3, 3>& other);

    template<typename U>
    Mat<T, 3, 3>& operator+=(U val);
