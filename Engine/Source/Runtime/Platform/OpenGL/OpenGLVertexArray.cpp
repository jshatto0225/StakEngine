...
void OpenGLVertexArray::add_vertex_buffer(VertexBuffer *vbo) {
  bind();
  vbo->bind();
...
void OpenGLVertexArray::set_index_buffer(IndexBuffer *ibo) {
  bind();
  ibo->bind();
  index_buffer = ibo;
}
...
const std::vector<VertexBuffer *> &OpenGLVertexArray::get_vertex_buffers() const {
  return vertex_buffers;
}

const IndexBuffer *OpenGLVertexArray::get_index_buffer() const {
  return index_buffer;
}
