...
FVulkanDescriptorSetLayout::FVulkanDescriptorSetLayout(VkDevice Device, const FRHIDescriptorSetLayoutDescription &Description) : Device(Device) {
    ...
    CHECK_VK_ERR(vkCreateDescriptorSetLayout(Device, &Info, nullptr, &Layout), "Failed to create descriptor set layout");
}
