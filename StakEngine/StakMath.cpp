...
const vec4 &
mat4::operator[](i32 i) const
{
  return cols[i % 4];
}

mat4
ViewMatrix(const vec3 &Pos, const vec3 &Up, const vec3 &Forward)
{
  // TODO: Finish
  mat4 Result = {};
  Result[0][0] = 1.0f;
...
mat4
OrthographicProjection(f32 Left, f32 Right, f32 Bottom, f32 Top, f32 NearPlane, f32 FarPlane)
{
  mat4 Result = {};
...
mat4
Matmul(const mat4 *Mat1, const mat4 *Mat2)
{
  return
  {
...
vec4
MatVecMult(const mat4 *Mat, const vec4 *Vec)
{
  return
  {
...
mat4
Matmul(const mat4 *Mat1, const mat4 *Mat2, const mat4 *Mat3)
{
  mat4 Result = {};
...
mat4
TranslationMatrix(const vec3 *Pos)
{
  mat4 Result = {};
...
quat
DirectionVecToQuat(const vec3 *Vec)
{
  quat Result = {};
