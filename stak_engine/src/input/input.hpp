...
void set_raw_input(Platform::Window *window, bool value);
void set_cursor_visibility(Platform::Window *window, Cursor_Visibility visibility);

void add_key_state_callback(Input_State action, Key_Code key, void(*func)());
void add_generic_key_state_callback(Input_State action, void(*func)(Key_Code));
void add_generic_key_callback(void(*func)(Input_State, Key_Code));
  
void add_mouse_button_state_callback(Input_State action, Mouse_Code button, void(*func)());
void add_generic_mouse_button_state_callback(Input_State action, void(*func)(Mouse_Code));
